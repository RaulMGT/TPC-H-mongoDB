...
public class JavaMongoConnection {
	...
	private static List<Integer> orderkeylist;
	private static List<Integer> suppkeylist;
	private static List<Integer> custkeylist;
	private static List<Integer> nationkeylist;
	private static List<Integer> regionkeylist;
	private static List<Integer> partkeylist;
	...
	private static List<Document> getPartSuppObjects() {
	...
	private static List<Document> getLineItemObjects() {
